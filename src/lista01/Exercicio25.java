/*
25) Escreva um programa em Java para gerar uma matriz Y (N x M). Ordem os ele-
...
public class Exercicio25 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			try {
				...
				mtzOdenada = ordenarCrescenteMtz(mtzY);
	...
	static int[][] ordenarCrescenteMtz(int[][] mtz){
		...
		for(int i = 0; i < mtzResult.length; i++) {
			for(int x = 0; x < mtzResult[i].length; x++) {
				mtzResult[i][x] = valores[valIndex];
				valIndex++;
			}
		}
