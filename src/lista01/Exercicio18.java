...
public class Exercicio18 {
    ...
    static void lerInclusasAbaixo(){
        ...
        for(int i = 0; i < mtzQddR.length; i++){
            for(int t = 0; t < mtzQddR[i].length; t++)  {
                if(i <= t)
                    System.out.print(mtzQddR[i][t] + " ");                
            }                
        }
        //--
        System.out.print("\n* -Acima da diagonal secundaria (inclusa): ");
        for(int i = 0; i < mtzQddR.length; i++){
            for(int t = 0; t <= mtzQddR.length - i - 1; t++){
    ...
    static void lerMatriz() {
            System.out.println("\n\n-Matriz gerada\n");
            for(int i = 0; i < mtzQddR.length; i++) {
                    for(int x = 0; x < mtzQddR[i].length; x++) 
                            System.out.print((x == 0) ? mtzQddR[i][x] : "\t" + mtzQddR[i][x]);
                    System.out.println();
            }
    }
    ...
    static void gerarMatriz(){        
        ...
        mtzQddR = new int[dimN][dimN];
        
        for(int i = 0; i < mtzQddR.length; i++){
            for(int t = 0; t < mtzQddR[i].length; t++)  
            	mtzQddR[i][t] = rnd.nextInt(51);
        }
